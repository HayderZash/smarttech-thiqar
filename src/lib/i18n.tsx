...
const dict = {
  ...
  panelsNeeded: { ar: "الألواح المطلوبة (550 واط)", en: "Panels needed (550W)" },
  batteriesNeeded: { ar: "البطاريات المطلوبة (200Ah/12V)", en: "Batteries needed (200Ah/12V)" },
  ...
  voltageLabel: { ar: "الفولتية (V)", en: "Voltage (V)" },
  ...
  batteryType: { ar: "نوع البطارية", en: "Battery type" },
  batteryLead: { ar: "حامضية (DoD 50%)", en: "Lead-acid (50% DoD)" },
  batteryAgm: { ar: "جل / AGM (DoD 60%)", en: "Gel / AGM (60% DoD)" },
  batteryLithium: { ar: "ليثيوم LiFePO4 (DoD 90%)", en: "Lithium LiFePO4 (90% DoD)" },
  batteryCustom: { ar: "مخصص", en: "Custom" },
  batteryAh: { ar: "سعة البطارية (Ah)", en: "Battery capacity (Ah)" },
  batteryVolt: { ar: "فولتية البطارية (V)", en: "Battery voltage (V)" },
  dodLabel: { ar: "عمق التفريغ %", en: "Depth of discharge %" },
  autonomyDays: { ar: "أيام الاحتياط", en: "Backup days" },
